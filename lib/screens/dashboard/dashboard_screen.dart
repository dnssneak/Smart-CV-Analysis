              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: AtsScoreCard(
                      score: analysisProvider.currentAnalysis?.atsScore ??
                          (analysisProvider.analysisHistory.isNotEmpty
                              ? analysisProvider.analysisHistory.first.atsScore
                              : 0),
                      onTap: () {
                        if (analysisProvider.currentAnalysis != null ||
                            analysisProvider.analysisHistory.isNotEmpty) {
                          final analysis = analysisProvider.currentAnalysis ??
                              analysisProvider.analysisHistory.first;
                ...
                SliverPadding(
                  ...
                  sliver: analysisProvider.analysisHistory.isEmpty
                      ? SliverToBoxAdapter(
                          child: Center(
                            child: Padding(
                              padding: const EdgeInsets.all(AppSizes.xxl),
                      ...
                      : SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              final analysis =
                                  analysisProvider.analysisHistory[index];
                              return Padding(
                            ...
                            childCount:
                                analysisProvider.analysisHistory.length > 3
                                    ? 3
                                    : analysisProvider.analysisHistory.length,
                          ),
                        ),
                ),
